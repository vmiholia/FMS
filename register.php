    ...
    <div id="wrapper">
		...
		<div class="col-md-12">
			...
			<div>
				...
				<div>
					<div class="form-group">
							  <label class="col-md-5 control-label" for="rental">Admission No:</label>
							  <div class="col-md-3">
						<input type="text" name="tenant_id" id = "tenant_id" class="form-control input-md" title="input number only" placeholder="Admission Number" required/>
					</div>
				</div>
					<div class="form-group">
				...
				<div class="form-group">
							  <label class="col-md-5 control-label" for="room">Discount (Tuition Fees):</label>  
							  <div class="col-md-3">
											<input type="text" name="dis_id" id = "dis_id" class="form-control input-md" title="input number only" placeholder="Discount Amount (INR)" required/>
			
			</div>
			</div>
			<div class="form-group">
							  <label class="col-md-5 control-label" for="room">Discount (Development Fees):</label>  
							  <div class="col-md-3">
							<input type="text" name="dis_id2" id = "dis_id2" class="form-control input-md" title="input number only" placeholder="Discount Amount (INR)" required/>
			
			</div>
			</div>
			<div class="form-group">
			  <label class="col-md-5 control-label" for="room">Discount (Smart class Fees):</label>  
				  <div class="col-md-3">
					<input type="text" name="dis_id3" id = "dis_id3" class="form-control input-md" title="input number only" placeholder="Discount Amount (INR)" required/>
				</div>
			</div>
				...
				<div class="form-group">
							  <label class="col-md-5 control-label" for="rental">Transportation Fees:</label>
							  <div class="col-md-3">
						<input type="text" name="transportation_fees" id = "transportation_fees" class="form-control input-md" title="input number only" placeholder="transportation fee" required/>
					</div>
				</div>
				<div class="form-group">
							  <label class="col-md-5 control-label" for="rental">Annual Fees:</label>
							  <div class="col-md-3">
						<input type="text" name="annual_fees" id = "annual_fees" class="form-control input-md" title="input number only" placeholder="annual fee" required/>
					</div>
				</div>
...
<?php
	...
	$age=$_POST['age'];
	$dis_id=$_POST['dis_id'];
	$dis_id2=$_POST['dis_id2'];
	$dis_id3=$_POST['dis_id3'];
	$bdate=$_POST['bdate'];
	$address=$_POST['address'];
	$contact=$_POST['contact'];
	$transportation_fees=$_POST['transportation_fees'];
	$annual_fees=$_POST['annual_fees'];
	$monthh = strtotime('now');
	$mon = date('Y-m-d',$monthh);
	
	mysql_query("insert into tenant (tenant_id,room_id,fname,mname,lname,nname,gender,age,bdate,address,contact,date_registered,dis_id,dis_id2,dis_id3,annual_fees,transportation_fees) values('$tenant_id','$room_id','$water','$fname','$mname','$lname','$nname','$gender','$age','$bdate','$address','$contact','$mon','$dis_id','$dis_id2','$dis_id3','$annual_fees','$transportation_fees')")or die(mysql_error());
				?>
				<?php 
