...
<br><br>
 <div class="container-fluid">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading"><i class="fa fa-sitemap fa"></i>&nbsp;Add New Route	</div>
...
$query = mysql_query("select * from table_name where rname = '$room_name' ")or die(mysql_error());
...
mysql_query("insert into table_name (rname,busfee) values('$room_name','$rental')")or die(mysql_error());
