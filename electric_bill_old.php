        ...
        <div class="panel-body">
         <div class="pull-left">
            <form method="post" action="export1.php">
               <input type="submit" name="export" class="btn btn-success" value="Daily Transaction" />
           </form>
           <br>
           <form method="post" action="export2.php">
               <input type="submit" name="export" class="btn btn-success" value="Till Today" />
           </form>
           <br><br>
           <form method="post" action="emon4.php">
                <input type="submit" name="export" class="btn btn-success" value="Apr-May " />
        </form>
        <br><br>
        <form method="post" action="emon6.php">
         <input type="submit" name="export" class="btn btn-success" value="Jun-July" />
     </form>
     <br><br>
     <form method="post" action="emon8.php">
        <input type="submit" name="export" class="btn btn-success" value="Aug-Sept" />
    </form>
    <br><br>
    <form method="post" action="emon10.php">
        <input type="submit" name="export" class="btn btn-success" value="Oct-Nov " />
    </form>
    <br><br>
    <form method="post" action="emon12.php">
      <input type="submit" name="export" class="btn btn-success" value="Dec-Jan" />
  </form>
  <br><br>
  <form method="post" action="emon2.php">
    <input type="submit" name="export" class="btn btn-success" value="Feb-Mar" />
</form>
<br></div>
<div class="pull-right" id="report_view">
    nklnilbiblb
