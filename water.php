            ...
            <!-- /.navbar-collapse -->
				...
				<div id="block_bg" class="block">	
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<thead>
										  <tr>
												...
												<th><center>Admission_Number</center></th>
						...
						$query=mysql_query("SELECT * FROM tenant LEFT JOIN room
													ON tenant.room_id=room.room_id ORDER BY room_name")or die(mysql_error());
						...
						<td><center><h5><?php echo $rec['tenant_id'] ?></h5></center></td>
