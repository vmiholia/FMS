    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<li>
					<a href="javascript:;" data-toggle="collapse" data-target="#dem"><i class="fa fa-sitemap "></i> Transport fee<i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="dem" class="collapse">
							<li>
                                <a href="processAdd_room1.php" class="glyphicon glyphicon-plus">&nbsp;Add Transport Route</a>
                            </li>
                            <li>
                                <a href="rental.php" class="glyphicon glyphicon-eye-open">&nbsp;View Transport fee </a>
                            </li>
                 </li>       </ul>
...
<div id="page-wrapper">
            <div class="container-fluid">
				...
				<nav>
				<head>
				<center><h4><strong>Transport Fee</strong><h4></center>
					   <div class="col-sm-12">
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
									...
									<thead>
										...
										<tbody>
									<?php
													$user_query = mysql_query("select * from table_name")or die(mysql_error());
												...
												<td><strong><?php echo $row['rname']; ?><strong></td>
												<td width="100"><input type='text' readonly class="form-control input-md" value="<?php echo $row['busfee']; ?>"></td>
												<td class="col-md-1">
												<center><a button class="btn btn-success" title="Click here to View." href="edit_rental.php<?php echo '?id='.$row['rname'];?>">Edit Fees</a></center></td>
											</center>
